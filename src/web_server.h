...
#define SET_WEB_SERVER_TERMINAL_OUTPUT_ON				0				/*!Default - 0; set to 1 to send the commands and respective response from Gainspan device to serial terminal define in Gainspan data structure gainspan.serial_terminal_usart_id*/
